...
include "Controller/Control_Account.php";
$c_account= new Control_Account();
...
if(isset($_POST['dangki'])){
    ...
    if($password==$passwordAgain){
        $c_account->RegisterAccount($name,$email,$password);
    }
}
...
<body>
  ...
  <strong>Thông Báo: !</strong>'. $_SESSION["error"].'</div>';
                        ?>
                        	<div>
				    			<label>Họ tên</label>
